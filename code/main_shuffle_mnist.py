...
if __name__ == '__main__':
    ...
    for round in range(args.epochs):
        ...
        for client in range(args.num_clients):
            ...
            for k in net_glob_backup[client].state_dict().values():
            ...
            pre_norm = clients_norm[client]
            clients_norm[client] = torch.norm(norm_net-pre_norm_net)
            print(" Model_Weight_Norm :",clients_norm[client])
            
            client_slope = clients_norm[client]-pre_norm
            print(" Model_Weight_Norm_Slope :",client_slope)                
